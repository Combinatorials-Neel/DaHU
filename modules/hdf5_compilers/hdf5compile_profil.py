...
def write_dektak_reference_results_to_hdf5(position_group):
    ...
    current_sample_group = position_group.parent.parent.parent["sample"]
    current_active_layer_group = return_active_layer_group(current_sample_group)
    current_sample_time = current_active_layer_group["time"][()]
